...
public class SmartSwitchSystemInfo {
	public static String readSystemInfo() throws IOException, Exception {

		String SystemInfoResult = null;
	 ...
	 // System.out.println("----------------------------------------------------");
	    ...
	    try{SystemInfoResult = "Serial Number     :  " + SystemInfo.getSerial();}
	    catch(UnsupportedOperationException ex){}
